    ...
    features: [
      {
        ...
        content: "3D embroidery, flat embroidery, sublimation, and more.",
      },
      {
        heading: "Premium Quality",
        content: "Made from premium cotton and wool blends.",
      },
      {
        heading: "MOQ",
        content: "576 pcs per style/design.",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        content: "Fitted precisely for comfort and style.",
      },
      {
        heading: "OEM Services",
        content: "Private labeling and custom packaging available.",
      },
      {
        heading: "MOQ",
        content: "Minimum 576 pcs per size or style.",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        content: "Optional wide brims and UV-safe fabrics.",
      },
      {
        heading: "Print Options",
        content: "Sublimation, screen printing, or patchwork options.",
      },
      {
        heading: "MOQ",
        content: "576 pcs minimum per color/design.",
      },
    ],
  },
  {
