...
export default function ProcessPage() {
    return (
        <div className='mt-24 space-y-7 lg:space-y-0 container px-0 md:px-12  mx-auto'>
            ...
            {/* 1st */}
            <div className='flex flex-col   lg:flex-row gap-12   h-[500px] md:h-[450px]'>
                ...
                <div className='flex-1 h-[500px] md:h-[450px]'>
                    <Image src={img1} alt='logo' width={400} height={700} className='w-full h-[500px] md:h-[450px]' />
                </div>
            </div>
            {/* 2nd */}
            <div className='flex flex-col lg:flex-row-reverse  items-center lg:gap-12 gap-6  h-[500px] md:h-[450px]'>
                <div className='flex-1 '>
                ...
                <div className='flex-1 border-2 '>
                    <Image src={img2} alt='logo' width={700} height={700} className='w-full h-[500px] md:h-[450px]' />
                </div>
            </div>
            {/* 3rd */}
            <div className='flex flex-col  lg:flex-row items-center lg:gap-12 gap-6  h-[500px] md:h-[450px]'>
                <div className='flex-1 '>
                ...
                <div className='flex-1'>
                    <Image src={img3} alt='logo' width={700} height={700} className='w-full h-[500px] md:h-[450px]' />
                </div>
            </div>
            {/* 4th */}
            <div className='flex flex-col  lg:flex-row-reverse items-center lg:gap-12 gap-6  h-[500px] md:h-[450px]'>
                ...
                <div className='flex-1'>
                    <Image src={img5} alt='logo' width={700} height={700} className='w-full h-[500px] md:h-[450px]' />
                </div>
            </div>
